...
import uk.ac.cam.cl.olb22.exercises.Exercise6;
...
public class Exercise6Tester {
	...
	static final Path dataDirectory = Paths.get("data/topic1/task6/nuanced_sentiment_dataset");
	...
	public static void main(String[] args) throws IOException {
		...
		Path classPredictionsFile = Paths.get("data/topic1/task6/class_predictions.csv");
