...
copy config.py to config.py, and configure your client credentials.")
    sys.exit(1)
...
class OAuth2Client:
    ...
    def wait_for_auth_flow(self):
        ...
        callback_url = input(
            "Once you have obtained the callback link by clicking the login button in your email, paste your callback URL here: ").strip()
        try:
